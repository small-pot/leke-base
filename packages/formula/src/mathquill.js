...
// https://github.com/mathquill/mathquill/pull/191#discussion_r4327442
    ...
    LatexCmds.newSup = P(MathCommand, function (_, _super) {
        _.ctrlSeq = '\\newSup';
        _.htmlTemplate =
    ...
    LatexCmds.newSub = P(MathCommand, function (_, _super) {
        _.ctrlSeq = '\\newSub';
        _.htmlTemplate =
            '<span style="text-align: right">&0</span>' +
            '<span class="mq-supsub mq-non-leaf">' +
    ...
    LatexCmds.newSupSub = P(MathCommand, function (_, _super) {
        _.ctrlSeq = '\\newSupSub';
        _.htmlTemplate =
            '<span style="text-align: right">&0</span>' +
            '<span class="mq-supsub mq-non-leaf">' +
            '<span class="mq-sup">&1</span>' +
            '<span class="mq-sub">&2</span>' +
            '<span style="display:inline-block;width:0">​</span>' +
            '</span>'
    });
    LatexCmds['\u2211'] =
