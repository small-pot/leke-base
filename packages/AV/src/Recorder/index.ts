 ...
 * @LastEditTime: 2021-01-29 13:42:49
 */
...
class Recorder {
    ...
    initEvent(){
        const self = this;
        this.reRecorder && this.reRecorder.addEventListener('click',function(){
            const {elem}  = self.cfg;
    ...
    initAudio(){
        ...
        const src = url ? url : window.URL.createObjectURL(
    ...
    ondataavailable(event){
        this.cfg.onDataAvailable && this.cfg.onDataAvailable(event);
    }
}
